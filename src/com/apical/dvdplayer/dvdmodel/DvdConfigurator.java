...
public class DvdConfigurator
{
    private static final String TAG = "qulinglingDVD DvdConfigurator";
    ...
    //private DvdController mDvdController;

    public DvdConfigurator(Context context)
    {
        Log.d(TAG, "DvdConfigurator(" + context + ")");
        mPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        //mDvdController = new DvdController(context);
    }

//    public DvdController getDvdController()
//    {
//        Log.d(TAG, "getDvdController()");
//        return mDvdController;
//    }
...
//        }
    ...
    public void LoadDvdSettings(byte type)
    {
        ...
        //mDvdController.getSystemSetup(type);
    }
    ...
    public void SaveDvdSettings(byte type)
    {
        ...
        //mDvdController.setSystemSetup(param);
    }
