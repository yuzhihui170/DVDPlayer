...
import com.apical.dvdplayer.dvdview.SDHCMp5MusicActivity;
...
public class SDHCMp5Music extends SDHCEngineBase
{
	...
	private static SDHCMp5Music sdhcMp5Music = null;
	private SDHCMp5Music()
	{
		mdata = AppData.Instance();
	}
	public static SDHCMp5Music Instance()
	{
		if(sdhcMp5Music == null)
		{
			sdhcMp5Music = new SDHCMp5Music();
		}
	...
	public void Show(Context context)
	{
		...
		if(SDHCMp5MusicActivity.SDHCMp5MusicAct == null)
		{
			LogCat.Logd("SDHCMp5Music act = null");
			Intent mp5music = new Intent(context, 
					com.apical.dvdplayer.dvdview.SDHCMp5MusicActivity.class);
...
//        		}
	...
	{
		LogCat.Logd("SDHCMp5Music CmdCompleted cmd = " + cmd);
		switch(cmd)
		{
