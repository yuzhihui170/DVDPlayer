...
public class DVDMp5MusicActivity extends Activity
{
	public static Activity DVDMp5MusicAct = null;
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		setContentView(R.layout.dvd_mp5music_activity);
	...
	{
		finish();
		Intent serviceIntent = new Intent(DVDMp5MusicActivity.this, 
	...
	private BroadcastReceiver mReceiver = new BroadcastReceiver() 
	{
		...
		public void onReceive(Context context, Intent intent) 
		{
			if(intent.getAction().equals(DVDDealSet.DVD_ACTIVITY_EXIT))
			{
				...
				DVDMp5MusicActivity.this.finish();
			}
