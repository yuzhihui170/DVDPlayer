...
public class DVDMp5Activity extends Activity
{
	public static Activity DVDMp5Act = null;
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		DVDMp5Act = this;
		setContentView(R.layout.dvd_mp5list_activity);
		...
		mVedioListItemAdapter= new SimpleAdapter(DVDMp5Activity.this, mListVideoItem,  
				 R.layout.datalistview_item,
				 new String[] { "item_icon", "Index", "Media_name" },
				 new int[] { R.id.item_icon, R.id.Media_ID, R.id.Media_name });
				
		mMusicListItemAdapter= new SimpleAdapter(DVDMp5Activity.this, mListMusicItem,  
				 R.layout.datalistview_item,
				 new String[] { "item_icon", "Index", "Media_name" },
				 new int[] { R.id.item_icon, R.id.Media_ID, R.id.Media_name });
		
		mPictureListItemAdapter= new SimpleAdapter(DVDMp5Activity.this, mListPictureItem,  
				 R.layout.datalistview_item,
				 new String[] { "item_icon", "Index", "Media_name" },
				 new int[] { R.id.item_icon, R.id.Media_ID, R.id.Media_name });
	...
	OnItemClickListener datalistListener = new OnItemClickListener()
	{
		...
		public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				long arg3)
		{
			LogCat.Logd("DVDMp5Activity OnItemClickListener arg2 = " + arg2);
			Intent serviceIntent = new Intent(DVDMp5Activity.this, 
					com.apical.dvdplayer.dvdcontrol.DVDService.class);
			Bundle bundle = new Bundle();
